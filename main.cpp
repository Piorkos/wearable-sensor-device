...
#include "drivers/sharp_mip/write.h"

// ---SPI
// Pins for Arduino
#define SCK_PIN  6     // SCLK / SCK
#define MOSI_PIN 7     // MOSI / COPI
#define SS_PIN   5     // SS / CS
...
int main() {
    ...
    // Screen test
    printf("--- sharp_mip test START \n");

    std::string new_string{"HELLO"};
    sharp_mip::WriteLine(5, 0, new_string);
    new_string = "DOMINIK";
    sharp_mip::WriteLine(0, 20, new_string);
    ...
    new_string = "CZE";
    sharp_mip::WriteLine(0, 0, new_string);
    new_string = "DOMINIK";
    sharp_mip::WriteLine(3, 20, new_string);
    new_string = "EUREKA";
    sharp_mip::WriteLine(2, 80, new_string);
    sharp_mip::RefreshScreen(0, 96);
    sleep_ms(800);


    printf("--- sharp_mip test END \n");
